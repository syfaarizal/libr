...
export default function HeroSection() {
  ...
  useEffect(() => {
    const handler = (e: MouseEvent) => {
      const button = document.getElementById('CV-btn');
        ...
        <div className="home-content">
          ...
          <div className="hero-buttons">
            ...
            <div className="cv-dropdown">
              ...
              <div
                id="extraLinks"
                className={`cv-dropdown-content${showDropdown ? ' show' : ''}`}
              >
                <a
                  href="./assets/CV/CV-FrontEnd-Ind.pdf"
                  className="cv-link"
                  download
                >
                ...
                <a
                  href="./assets/CV/CV-FrontEnd-Eng.pdf"
                  className="cv-link"
                  download
                >
